...
ActiveRecord::Schema[7.0].define(version: 2023_04_14_153110) do
  create_table "actions", force: :cascade do |t|
    ...
    t.index ["creator_id"], name: "index_actions_on_creator_id"
  end
  ...
  add_foreign_key "actions", "users", column: "creator_id"
  add_foreign_key "attendances", "actions", column: "attended_id"
